...
WebUI.navigateToUrl('https://uat.almliquor.com.au/customer/login')
//WebUI.navigateToUrl('https://portal.almliquor.com.au/customer/login')

WebUI.click(findTestObject('Object Repository/Page_Login/input_Customer ID_j_username'))
WebUI.setText(findTestObject('Object Repository/Page_Login/input_Customer ID_j_username'), '78259099')
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Login/input_Password_j_password'), 'M1Lnyl0phgn1JV2kuvT1pw==')
