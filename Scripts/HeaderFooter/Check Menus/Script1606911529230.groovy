...
WebUI.callTestCase(findTestCase('_Goto_page/_Goto_Favorites_page'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('_Goto_page/_Goto_UploadOrder_page'), [:], FailureHandling.STOP_ON_FAILURE)
