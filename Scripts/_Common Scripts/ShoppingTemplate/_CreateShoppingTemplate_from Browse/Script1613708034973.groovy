...
// WebUI.callTestCase(findTestCase('ShoppingTemplate_Page/_AddToShoppingTemplate_Browse'), [('category') : 'cider'], FailureHandling.STOP_ON_FAILURE)
// -----------------------------------------------
...
WebUI.callTestCase(findTestCase('_Common Scripts/ShoppingTemplateDetails/_CheckProductCountInTemplate'), [('product_count'):'4'], FailureHandling.STOP_ON_FAILURE)

// Place the TemplateName in the Global Variables so other Test Scripts in Test Suites can use it
GlobalVariable.ShoppingTemplateName = templateName
