...
String cart_ProductCount = WebUI.callTestCase(findTestCase('_Common Scripts/MyCart/_GetProductCountInCart'), [:], FailureHandling.STOP_ON_FAILURE)
...
String cart_ProductCount2 = WebUI.callTestCase(findTestCase('_Common Scripts/MyCart/_GetProductCountInCart'), [:], FailureHandling.STOP_ON_FAILURE)
