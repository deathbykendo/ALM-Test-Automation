...
WebUI.setText(findTestObject('Object Repository/Page_Login/input_Customer ID_j_username'), username)

WebUI.setText(findTestObject('Object Repository/Page_Login/input_Password_j_password'), password)
