...
String cart_ProductCount = WebUI.callTestCase(findTestCase('MyCart/_GetProductCountInCart'), [:], FailureHandling.STOP_ON_FAILURE)
...
String cart_ProductCount2 = WebUI.callTestCase(findTestCase('MyCart/_GetProductCountInCart'), [:], FailureHandling.STOP_ON_FAILURE)
